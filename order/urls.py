...
urlpatterns = [
    ...
    path('estimate/<int:order_id>/<int:lionders_id>',views.estimate_lionders,name='estimate_lionders'),
    path('estimate/complete/',views.estimate_lionders,name='estimate_complete'),
]